...
get_ipython().system('pip install ema_pytorch')
...
trainer.load(ckpt)
trainer.inference(output_path='./submission/simple')
...
get_ipython().system('wget https://raw.githubusercontent.com/nagadomi/lbpcascade_animeface/master/lbpcascade_animeface.xml -O lbpcascade_animeface.xml')
...
fid = calculate_fid(real_images_path, './submission/simple')
afd = calculate_afd('./submission/simple')
